...
import { Github, Linkedin, Mail, ExternalLink, Menu, X, ChevronDown, Code, Palette, Zap, Globe, Download, Phone, MapPin } from 'lucide-react';
...
const ModernPortfolio = () => {
  ...
  const scrollToSection = (sectionId) => {
    const refs = { home: heroRef, about: aboutRef, projects: projectsRef, skills: skillsRef, contact: contactRef };
  ...
  const projects = [
    ...
    },
    {
      ...
      category: 'backend',
      technologies: ['GraphQL', 'Apollo', 'PostgreSQL', 'Docker'],
      github: '#',
      demo: '#'
    }
  ];
  ...
  const skills = [
    ...
    { name: 'TypeScript', level: 90, icon: Code, color: 'from-blue-600 to-purple-600' },
    { name: 'Node.js', level: 88, icon: Zap, color: 'from-green-500 to-emerald-500' },
    { name: 'UI/UX Design', level: 85, icon: Palette, color: 'from-pink-500 to-rose-500' },
    { name: 'Cloud (AWS)', level: 82, icon: Globe, color: 'from-orange-500 to-red-500' },
    { name: 'GraphQL', level: 80, icon: Code, color: 'from-purple-500 to-indigo-500' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-pink-500/5 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <section ref={heroRef} className="min-h-screen flex items-center justify-center relative pt-16">
        <div className={`max-w-4xl mx-auto text-center px-4 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="mb-8">
          ...
          <div className="flex justify-center space-x-6">
            <a href="#" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-all duration-300 transform hover:scale-110">
              <Github size={24} />
            </a>
            <a href="#" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-all duration-300 transform hover:scale-110">
              <Linkedin size={24} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-gray-300 leading-relaxed">
                I'm a passionate full-stack developer with 5+ years of experience creating digital solutions that combine functionality with beautiful design. My journey in tech started with a curiosity about how things work and evolved into a love for building products that make a difference.
              </p>
              
              <p className="text-lg text-gray-300 leading-relaxed">
                When I'm not coding, you'll find me exploring the latest design trends, contributing to open-source projects, or sharing knowledge with the developer community. I believe in continuous learning and staying ahead of the curve in this ever-evolving field.
              </p>
              ...
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-blue-500/20 backdrop-blur-sm border border-white/10 p-8">
                <div className="w-full h-full bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-500 mt-2">Replace with your actual photo</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section ref={projectsRef} className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {['all', 'frontend', 'fullstack', 'mobile', 'backend'].map((filter) => (
              <button
                key={filter}
